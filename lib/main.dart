...
import 'package:interfaz01/description_place.dart';
import 'package:interfaz01/review_list.dart';
import 'package:interfaz01/gradient_back.dart';
      ...
      home: Scaffold(
        body: Stack(
          children: <Widget>[
            ListView(
              children: <Widget>[
                DescripcionPlace("Bahamas",5,descriptionDummy),
                ReviewList()
              ],
            ),
            HeaderAppBar()
